...
~~タイムスタンプ（4byte）, x 軸加速度積算値（4byte）, y 軸加速度積算値（4byte）, z 軸加速度積算値（4byte）, 温度（2byte）, 湿度（2byte）を 5 秒間隔で保存~~

~~5秒あたり20byte。1 分で 240byte。1 時間で 14.4KB。12 時間で 172.8KB。~~

~~5日は保存したいので、1日（MAX12時間）x5=864KB分は確保したい。~~

タイムスタンプ（4byte）, 加速度積算値1（2byte）, 加速度積算値2（2byte）, 加速度積算値3（2byte）, 加速度積算値4（2byte）, 加速度積算値5（2byte）, 加速度積算値6（2byte）, 加速度積算値7（2byte）, 加速度積算値8（2byte）, 加速度積算値9（2byte）, 加速度積算値10（2byte）, 温度（2byte）, 湿度（2byte）を 5 秒間隔で保存。
