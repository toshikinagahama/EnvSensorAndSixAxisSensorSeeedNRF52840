...
#define ADDRESS_DATA_PAGE_1                                                    \
  12288 +                                                                      \
      (0 * NUM_UNIT_DATA_PAGE * UNIT_DATA_PAGE) // データページ1の先頭アドレス
#define ADDRESS_DATA_PAGE_2                                                    \
  12288 +                                                                      \
      (1 * NUM_UNIT_DATA_PAGE * UNIT_DATA_PAGE) // データページ2の先頭アドレス
#define ADDRESS_DATA_PAGE_3                                                    \
  12288 +                                                                      \
      (2 * NUM_UNIT_DATA_PAGE * UNIT_DATA_PAGE) // データページ3の先頭アドレス
#define ADDRESS_DATA_PAGE_4                                                    \
  12288 +                                                                      \
      (3 * NUM_UNIT_DATA_PAGE * UNIT_DATA_PAGE) // データページ4の先頭アドレス
#define ADDRESS_DATA_PAGE_5                                                    \
  12288 +                                                                      \
      (4 * NUM_UNIT_DATA_PAGE * UNIT_DATA_PAGE) // データページ5の先頭アドレス
